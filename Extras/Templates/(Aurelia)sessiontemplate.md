...
actions:
  - type: templaterCreateNote
    templateFile: "Extras/Templates/(Aurelia)sessiontemplate.md"
    folderPath: "Adventures/Aurelia/Session Notes"
    fileName: ""
    openNote: true
```
---
...
actions:
  - type: inlineJS
    code: |
      const folderPath = `Adventures/Aurelia/Session Notes`;
...
tp.hooks.on_all_templates_executed(async () => {
  ...
  if (summaryMatch) {
    ...
    const summaryTempPath = "Extras/SYS/Aurelia_summary.md";
