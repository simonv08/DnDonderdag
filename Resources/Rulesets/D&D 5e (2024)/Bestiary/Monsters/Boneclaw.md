...
***Shadow Stealth.*** While in dim light or darkness, the boneclaw can take the [[Actions#Hide|Hide]] action as a bonus action.

### Actions
***Multiattack.*** The boneclaw makes two claw attacks.

***Piercing Claw.*** 8 to hit, reach 15 ft., one target. 20 (3d10 + 4) piercing damage. If the target is a creature, the boneclaw can pull the target up to 10 feet toward itself, and the target is [[Conditions#grappled|Grappled]] (escape 14). The boneclaw has two claws. While a claw grapples a target, the claw can attack only that target.
