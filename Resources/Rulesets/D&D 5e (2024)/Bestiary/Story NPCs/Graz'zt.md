...
***Wave of Sorrow (Greatsword).*** 13 to hit, reach 10 ft., one target. 20 (4d6 + 6) slashing damage plus 10 (3d6) acid damage.
...
***Dance, My Puppet.*** One creature [[Conditions#charmed|Charmed]] by Graz'zt that Graz'zt can see must use its reaction to move up to its speed as Graz'zt directs.
