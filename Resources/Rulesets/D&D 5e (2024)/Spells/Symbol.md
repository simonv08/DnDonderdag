...
Range: "Touch"
saving_throws: ["Constitution", "Wisdom", "Intelligence"]
duration: "Permanent"
verbal: true
somatic: true
material: true
Components: ["powdered diamond worth 1,000+ GP, which the spell consumes"]
concentration: false
source: ["XPHB"]
ruleset: "D&D 5e (2025)"
---
...
**Saving Throw:** Constitution, Wisdom, Intelligence
**Duration:** Permanent
...
Once triggered, the glyph glows, filling a 60-foot-radius  with  for 10 minutes, after which time the spell ends. Each creature in the  when the glyph activates is targeted by its effect, as is a creature that enters the  for the first time on a turn or ends its turn there. A creature is targeted only once per turn.
...
##### Discord
Each target makes a Wisdom saving throw. On a failed save, a target argues with other creatures for 1 minute. During this time, it is incapable of meaningful communication and has  on attack rolls and ability checks.
