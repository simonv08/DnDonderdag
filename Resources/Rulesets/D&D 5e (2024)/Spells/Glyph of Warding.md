...
somatic: true
material: true
Components: ["powdered diamond worth 200+ GP, which the spell consumes"]
concentration: false
source: ["XPHB"]
ruleset: "D&D 5e (2025)"
---
...
When the glyph is triggered, the stored spell takes effect. If the spell has a target, it targets the creature that triggered the glyph. If the spell affects an area, the area is centered on that creature. If the spell summons  creatures or creates harmful objects or traps, they appear as close as possible to the intruder and attack it. If the spell requires [[Statuss#Concentration|Concentration]], it lasts until the end of its full duration.
