...
somatic: true
material: true
Components: ["for each of the spell's targets, one jacinth worth 1,000+ GP and one silver bar worth 100+ GP, all of which the spell consumes"]
concentration: false
source: ["XPHB"]
ruleset: "D&D 5e (2025)"
---
...
Any damage or other effects that apply to an astral form have no effect on the target's body and vice versa. If a target's body or astral form drops to 0 , the spell ends for that target. The spell ends for all the targets if you take a [[Actions#Magic|Magic]] action to dismiss it.
