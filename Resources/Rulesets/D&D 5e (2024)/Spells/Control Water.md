...
somatic: true
material: true
Components: ["a mixture of water and dust"]
concentration: true
source: ["XPHB"]
ruleset: "D&D 5e (2025)"
---
...
Until the spell ends, you control any water inside an area you choose that is a  up to 100 feet on a side, using one of the following effects. As a [[Actions#Magic|Magic]] action on your later turns, you can repeat the same effect or choose a different one.
