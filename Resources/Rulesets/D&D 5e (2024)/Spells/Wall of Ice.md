...
**Saving Throw:** Dexterity, Constitution
**Duration:** 10 minute (concentration)
...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30  per 10-foot section, and it has  to Cold, Poison, and Psychic damage and  to Fire damage. Reducing a 10-foot section of wall to 0  destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
