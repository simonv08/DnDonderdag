...
size: ["Small"]
speed: ["Walk 30 ft."]
traits: ["[[Autognome#Creature Type|Creature Type]]", "[[Autognome#Armored Casing|Armored Casing]]", "[[Autognome#Built For Success|Built for Success]]", "[[Autognome#Healing Machine|Healing Machine]]", "[[Autognome#Mechanical Nature|Mechanical Nature]]", "[[Autognome#Sentrys Rest|Sentry's Rest]]", "[[Autognome#Specialized Design|Specialized Design]]"]
tool-prof: ["Choose 2 "]
...
##### Mechanical Nature
You have resistance to poison damage and immunity to disease, and you have advantage on saving throws against being [[Conditions#paralyzed|Paralyzed]] or [[Conditions#poisoned|Poisoned]]. You don't need to eat, drink, or breathe.
##### Sentry's Rest
