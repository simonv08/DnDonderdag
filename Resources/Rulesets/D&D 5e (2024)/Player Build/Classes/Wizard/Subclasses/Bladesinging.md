---
traits: ["[[Bladesinging#Bladesinging|Bladesinging]]", "[[Bladesinging#Bladesinger Styles|Bladesinger Styles]]", "[[Bladesinging#Bladesong|Bladesong]]", "[[Bladesinging#Training In War And Song Bladesinging|Training in War and Song (Bladesinging)]]", "[[Bladesinging#Extra Attack|Extra Attack]]", "[[Bladesinging#Song Of Defense|Song of Defense]]", "[[Bladesinging#Song Of Victory|Song of Victory]]"]
---
...
- You have advantage on Dexterity ([[Skills#Acrobatics|Acrobatics]]) checks.
- You gain a bonus to any Constitution saving throws you make to maintain [[Statuss#concentration|Concentration]] on a spell. The bonus equals your Intelligence modifier (minimum of +1).
...
You also gain proficiency in the [[Skills#Performance|Performance]] skill if you don't already have it.
...
Starting at 6th level, you can attack twice, instead of once, whenever you take the [[Actions#Attack|Attack]] action on your turn. Moreover, you can cast one of your cantrips in place of one of those attacks.
