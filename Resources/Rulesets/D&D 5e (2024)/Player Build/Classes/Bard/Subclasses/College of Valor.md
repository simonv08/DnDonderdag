---
traits: ["[[College of Valor#College Of Valor|College of Valor]]", "[[College of Valor#Combat Inspiration|Combat Inspiration]]", "[[College of Valor#Martial Training|Martial Training]]", "[[College of Valor#Extra Attack|Extra Attack]]", "[[College of Valor#Battle Magic|Battle Magic]]"]
---
...
When the creature is hit by an attack roll, that creature can use its  to roll the Bardic Inspiration die and add the number rolled to its AC against that attack, potentially causing the attack to miss.
...
In addition, you can use a Simple or Martial weapon as a  to cast spells from your Bard spell list.
...
After you cast a spell that has a casting time of an action, you can make one attack with a weapon as a .