---
traits: ["[[Path of the Giant#Giant Power|Giant Power]]", "[[Path of the Giant#Giants Havoc|Giant's Havoc]]", "[[Path of the Giant#Path Of The Giant|Path of the Giant]]", "[[Path of the Giant#Elemental Cleaver|Elemental Cleaver]]", "[[Path of the Giant#Mighty Impel|Mighty Impel]]", "[[Path of the Giant#Demiurgic Colossus|Demiurgic Colossus]]"]
---
...
- {"type":"item","name":"Crushing Throw","entry":"When you make a successful ranged attack with a thrown weapon using Strength, you can add your Rage Damage bonus to the attack's damage roll."}
- {"type":"item","name":"Giant Stature","entry":"Your reach increases by 5 feet, and if you are smaller than Large, you become Large, along with anything you are wearing. If there isn't enough room for you to increase your size, your size doesn't change."}
...
If, at the end of this movement, the thrown creature isn't on a surface or liquid that can support it, the creature falls, taking damage as normal and landing [[Conditions#prone|Prone]].
