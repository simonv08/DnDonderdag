---
traits: ["[[Lunar Sorcery#Lunar Sorcery|Lunar Sorcery]]", "[[Lunar Sorcery#Lunar Embodiment|Lunar Embodiment]]", "[[Lunar Sorcery#Moon Fire|Moon Fire]]", "[[Lunar Sorcery#Lunar Boons|Lunar Boons]]", "[[Lunar Sorcery#Waxing And Waning|Waxing and Waning]]", "[[Lunar Sorcery#Lunar Empowerment|Lunar Empowerment]]", "[[Lunar Sorcery#Lunar Phenomenon|Lunar Phenomenon]]"]
---
...
- {"type":"item","name":"Full Moon","entries":["Abjuration and divination spells"]}
- {"type":"item","name":"New Moon","entries":["Enchantment and necromancy spells"]}
- {"type":"item","name":"Crescent Moon","entries":["Illusion and transmutation spells"]}
...
- {"type":"item","name":"Full Moon","entries":["You can use a bonus action to shed bright light in a 10-foot radius and dim light for an additional 10 feet or to douse the light. In addition, you and creatures of your choice have advantage on Intelligence ([[Skills#Investigation|Investigation]]) and Wisdom ([[Skills#Perception|Perception]]) checks while within the bright light you shed."]}
- {"type":"item","name":"New Moon","entries":["You have advantage on Dexterity ([[Skills#Stealth|Stealth]]) checks. In addition, while you are entirely in darkness, attack rolls have disadvantage against you."]}
- {"type":"item","name":"Crescent Moon","entries":["You have resistance to necrotic and radiant damage."]}
