---
name: "Inheritor"
skills: ["Choose 1", "Survival"]
skill_choice_list: ["Arcana", "History", "Religion"]
tool-prof: ["Choose 1"]
tool_choice_list: ["Musical instrument", "Gaming set"]
traits: ["[[Inheritor#Inheritance|Inheritance]]", "[[Inheritor#Suggested Characteristics|Suggested Characteristics]]"]
...
**Skill Proficiencies:** Choose undefined from arcana, history, religion

**Languages:** 1 of your choice

**Tool Proficiencies:** Choose undefined from Musical instrument, Gaming set
...
Use the tables for the  background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as an inheritor.
