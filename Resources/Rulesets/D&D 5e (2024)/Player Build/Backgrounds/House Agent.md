...
tool-prof: ["Alchemist's supplies", "Tinker's tools", "Choose 1 Gaming Set", "Vehicles (land)", "Brewer's supplies", "Cook's utensils", "Herbalism kit", "Thieves' tools", "Vehicles (water)", "Vehicles (air)", "Navigator's tools", "Disguise kit", "Choose 1 Musical Instrument", "Calligrapher's supplies", "Forgery kit", "Poisoner's kit"]
traits: ["[[House Agent#Role|Role]]", "[[House Agent#House Connections|House Connections]]", "[[House Agent#Suggested Characteristics|Suggested Characteristics]]"]
...
**Tool Proficiencies:** Alchemist's supplies, Tinker's tools, Vehicles (land), Brewer's supplies, Cook's utensils, Alchemist's supplies, Herbalism kit, Tinker's tools, Thieves' tools, Vehicles (water), Vehicles (air), Navigator's tools, Thieves' tools, Disguise kit, Disguise kit, Calligrapher's supplies, Forgery kit, Thieves' tools, Poisoner's kit, Vehicles (land), Herbalism kit
