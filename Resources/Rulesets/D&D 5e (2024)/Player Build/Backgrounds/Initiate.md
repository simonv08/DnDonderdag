...
tool-prof: ["Choose 1 Gaming Set", "Vehicles (land)"]
traits: ["[[Initiate#Trials Of The Five Gods|Trials of the Five Gods]]", "[[Initiate#Suggested Characteristics|Suggested Characteristics]]"]
...
- One set of gaming dice (of your choice)
- [[Common Clothes]]
- [[Pouch]] (15 gp)
...
| d6 | Ideal |
| :-- | :-- |
| 1 |  The thing that matters most of all is that we're there for each other. (Lawful) |
| 2 |  The world is a puzzle—a mystery waiting to be solved. (Neutral) |
| 3 |  All that matters to me is my own perfection. Let everyone else seek that perfection in their own way. (Any) |
| 4 |  I'm going to prove that I deserve only the best—of everything. (Evil) |
| 5 |  Anything worth doing is worth throwing my whole self into. (Any) |
| 6 |  I will train all the harder to make up for the doubt I entertained when I was younger. (Any) |
