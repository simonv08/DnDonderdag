...
#### Winters Howl
As an action, you can cast [[Sleet Storm]] (spell save 17). You regain this ability after you finish a short or long rest.
#### Gift of Frost
...
- **Cloak.** The cloak is now a rare magic item that requires attunement. While wearing it, you have resistance to fire damage, and you have advantage on Dexterity ([[Skills#Stealth|Stealth]]) checks made while in snowy terrain.
- **Boots.** The pair of boots is now a rare magic item that requires attunement. While wearing it, you ignore [[Rules#Difficult Terrain]] while walking, and you can walk on water.
