...
- **Geyser.** The decanter produces 30 gallons of water that gushes forth in a  30 feet long and 1 foot wide. If you're holding the decanter, you can aim the geyser in one direction (no action required). One creature of your choice in the  must succeed on a 13 Strength saving throw or take 1d4 Bludgeoning damage and have the [[Conditions#Prone|Prone]] condition. Instead of a creature, you can target one object in the  that isn't being worn or carried and that weighs no more than 200 pounds. The object is knocked over by the geyser.
