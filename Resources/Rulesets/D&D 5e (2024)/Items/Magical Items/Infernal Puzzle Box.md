...
A creature that spends 1 hour holding an infernal puzzle box while trying to open it can make a 30 Intelligence ([[Skills#Investigation|Investigation]]) check. If the check succeeds, the creature figures out the trick or sequence of steps needed to open the box. If the check fails by 5 or more, the creature must make a 18 Wisdom saving throw, taking 42 (12d6) psychic damage on a failed save, or half as much damage on a successful one.
