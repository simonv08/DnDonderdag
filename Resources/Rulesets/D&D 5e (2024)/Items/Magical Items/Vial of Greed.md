...
- Up to 5 magic scrolls that affect a single creature. The target of the spell is you, and if the spell requires [[Statuss#concentration|Concentration]], you can concentrate.
