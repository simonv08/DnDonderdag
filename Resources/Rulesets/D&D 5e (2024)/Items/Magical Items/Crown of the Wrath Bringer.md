...
#### Invoking the Rune
As an action, you can invoke the crown's rune to cast the [[Fear]] spell (save 15) with it; the spell has a duration of 1 minute and doesn't require [[Statuss#concentration|Concentration]]. Once the rune has been invoked, it can't be invoked again until the next dawn.
