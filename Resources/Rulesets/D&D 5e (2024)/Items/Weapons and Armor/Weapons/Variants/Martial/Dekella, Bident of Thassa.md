...
- **Piety 25+.** The bident has 1 randomly determined  property.
- **Piety 50+.** The bident has 1 randomly determined  property.

If you aren't a worshiper of Thassa, the bident has 1  property and 1  property, both randomly determined.
...
Additionally, you can cast the [[Dominate Monster]] spell (save 18) from the bident, but only on beasts and monstrosities that have an innate swimming speed. Once used, this property of the bident can't be used again until the next dusk.
#### Aquatic Metamorphosis
You can cast the [[True Polymorph]] spell (save 18) from the bident, but you must cast it on a creature to turn it into a kind of creature that has an innate swimming speed. Once used, this property of the bident can't be used again until the next dusk.
