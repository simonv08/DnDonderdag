...
#### Destroy Devotion
Once per turn when you hit a creature with this weapon, you can expend 1 of its charges to attempt to render the target powerless. The target must succeed on a 17 Constitution saving throw or have the [[Conditions#paralyzed|Paralyzed]] condition until the start of your next turn. Celestials have disadvantage on the save.
#### Faith Hunter
