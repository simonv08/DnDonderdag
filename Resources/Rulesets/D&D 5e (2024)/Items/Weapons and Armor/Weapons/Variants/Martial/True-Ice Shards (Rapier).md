...
*This item is paired with [[True-ice Shards (dagger)]]*
...
#### Mental Command
While attuned to the True-Ice Shards, you can use an action to cast the [[Detect Thoughts]] spell (save 20), targeting any creature you have previously met. If the targeted creature is on a different plane of existence, the spell fails.
As long as you maintain [[Statuss#concentration|Concentration]], you can use a bonus action to send a telepathic message to the focused creature. It can reply—using a bonus action to do so—as long as the focus and [[Statuss#concentration|Concentration]] continue.
#### Omniscient
