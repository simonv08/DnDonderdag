...
somatic: true
material: true
Components: ["a shard of onyx and a drop of the caster's blood, both of which the spell consumes"]
concentration: true
...
For the duration, the spell's area is [[Rules#Difficult Terrain]]. A creature with darkvision can't see through the magical darkness, and nonmagical light can't illuminate it. No sound can be created within or pass through the area. Any creature or object entirely inside the sphere is immune to thunder damage, and creatures are [[Conditions#deafened|Deafened]] while entirely inside it. Casting a spell that includes a verbal component is impossible there.
