...
***Bite.*** 10 to hit, reach 10 ft., one target. 33 (4d12 + 7) piercing damage. If the target is a Medium or smaller creature, it is [[Conditions#grappled|Grappled]] (escape 17). Until this grapple ends, the target is [[Conditions#restrained|Restrained]] and the tyrannosaurus zombie can't bite another target or disgorge zombies.
