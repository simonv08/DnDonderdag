...
***Incorporeal Movement.*** The phantom warrior can move through other creatures and objects as if they were [[Rules#Difficult Terrain]]. It takes 5 (1d10) force damage if it ends its turn inside an object.
...
***Spectral Longsword.*** 5 to hit, reach 5 ft., one target. 7 (1d8 + 3) force damage.
