...
***Poison Spores.*** Whenever the chamberlain takes damage, it releases a cloud of spores. Creatures within 5 feet of the chamberlain when this happens must succeed on a 12 Constitution saving throw or be [[Conditions#poisoned|Poisoned]] for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on a success.

### Actions
***Multiattack.*** The chamberlain makes two slam attacks.

***Slam.*** 5 to hit, reach 5 ft., one target. 10 (2d6 + 3) bludgeoning damage.
