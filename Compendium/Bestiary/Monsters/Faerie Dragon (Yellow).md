...
***Superior Invisibility.*** As a bonus action, the dragon can magically turn [[Conditions#invisible|Invisible]] until its [[Statuss#concentration|Concentration]] ends (as if [[Statuss#concentration|Concentration]] on a spell). Any equipment the dragon wears or carries is [[Conditions#invisible|Invisible]] with it.
...
### Actions
***Bite.*** 7 to hit, reach 5 ft., one creature. 1 piercing damage.
