...
### Actions
***Infestation.*** 3 to hit, reach 0 ft., one target in the swarm's space. 10 (4d4) piercing damage, or 5 (2d4) piercing damage if the swarm has half of its hit points or fewer. A creature damaged by the swarm must succeed on a 12 Constitution saving throw or contract a disease. Each time the diseased creature finishes a long rest, roll a d6 to determine the disease's effect: 
- ***1-2.*** The creature is [[Conditions#blinded|Blinded]] until it finishes a long rest.
