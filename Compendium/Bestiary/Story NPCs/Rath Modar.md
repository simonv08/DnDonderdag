...
### Spellcasting
***Spellcasting.***
Rath is an 11th-level spellcaster who uses Intelligence as his spellcasting ability (spell save 15, 7 to hit with spell attacks). Rath has the following spells prepared from the wizard spell list:

### Traits
***Special Equipment.*** Rath has a [[Staff Of Fire]], and scrolls of [[Dimension Door]], [[Feather Fall]], and [[Fireball]].

### Actions
***Quarterstaff.*** 4 to hit, reach 5 ft., one target. 4 (1d8) bludgeoning damage.
