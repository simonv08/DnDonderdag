...
Medium Humanoid ([object Object]), Lawful Neutral
...
### Spellcasting
***Spellcasting.***
Othovir casts one of the following spells, using Charisma as the spellcasting ability (spell save 13; 5 to hit with spell attacks):
...
### Actions
***Rapier.*** 2 to hit, reach 5 ft., one target. 4 (1d8) piercing damage.
