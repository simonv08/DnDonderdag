...
### Spellcasting
***Innate Spellcasting.***
Mordakhesh's spellcasting ability is Charisma (spell save 18, 10 to hit with spell attacks). Mordakhesh can innately cast the following spells, requiring no material components:
...
***Greatsword.*** 10 to hit, reach 5 ft., one target. 12 (2d6 + 5) slashing damage plus 5 (1d10) force damage.

***Chromatic Orb.*** 10 to hit, range 120 ft., one creature. 13 (3d8) damage of a type chosen by Mordakhesh: acid, cold, fire, lightning, poison, or thunder.
