...
saving_throws: ["Constitution", "Intelligence", "Wisdom", "Charisma"]
...
### Spellcasting
***Innate Spellcasting.***
Sul Khatesh's spellcasting ability is Intelligence (spell save 26, 18 to hit with spell attacks). She can innately cast the following spells, requiring no material components:
...
***Master of Magic.*** Sul Khatesh has advantage on Constitution saving throws to maintain [[Statuss#concentration|Concentration]].

### Actions
***Multiattack.*** Sul Khatesh makes four attacks with Arcane Blast.

***Arcane Blast.*** 18 to hit, range 120 ft., one target. 15 (1d10 + 10) force damage.

***Magic Staff.*** 12 to hit, reach 5 ft., one target. 36 (5d12 + 4) force damage.

***Arcane Cataclysm (Recharges after a Long Rest).*** Sul Khatesh conjures orbs of magical energy that plummet to the ground at three different points she can see within 1 mile of her. Each creature in a 40-foot-radius sphere centered on each point must make a 26 Dexterity saving throw, taking 71 (11d12) force damage on a failed save or half as much damage on a successful one. A creature in the area of more than one arcane burst is affected only once. The area of each arcane burst then acts as an [[Antimagic Field]] for 1 hour. Sul Khatesh and spells she casts are unaffected by these fields.
...
***Consume Magic (Costs 2 Actions).*** Sul Khatesh targets a creature within 120 feet of her who is [[Statuss#concentration|Concentration]] on a spell. The target must succeed on a 26 Constitution saving throw or its [[Statuss#concentration|Concentration]] is broken on the spell, and Sul Khatesh gains 5 temporary hit points per level of that spell.

***Maddening Secrets (Costs 3 Actions).*** Sul Khatesh whispers an arcane secret into the mind of a creature she can see within 60 feet of her. The target must succeed on a 26 Wisdom saving throw or expend one of its spell slots of 3rd level or lower and deal 26 (4d12) force damage to each creature within 30 feet of it. A creature that fails the saving throw but can't expend a spell slot is instead [[Conditions#stunned|Stunned]] until the end of its next turn.