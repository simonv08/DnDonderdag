...
size: ["Medium"]
speed: ["Walk 30 ft."]
traits: ["[[Dragonborn (Gem)#Gem Ancestry|Gem Ancestry]]", "[[Dragonborn (Gem)#Breath Weapon|Breath Weapon]]", "[[Dragonborn (Gem)#Draconic Resistance|Draconic Resistance]]", "[[Dragonborn (Gem)#Psionic Mind|Psionic Mind]]", "[[Dragonborn (Gem)#Gem Flight|Gem Flight]]"]
dmg_resistance: [""]
