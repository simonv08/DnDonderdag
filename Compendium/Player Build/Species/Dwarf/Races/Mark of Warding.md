...
traits: ["[[Mark of Warding#Warders Intuition|Warder's Intuition]]", "[[Mark of Warding#Wards And Seals|Wards and Seals]]", "[[Mark of Warding#Spells Of The Mark|Spells of the Mark]]"]
int_mod: 1
...
***Warder's Intuition.*** When you make an Intelligence ([[Skills#Investigation|Investigation]]) check or an ability check using [[Thieves' Tools]], you can roll a d4 and add the number rolled to the ability check.
