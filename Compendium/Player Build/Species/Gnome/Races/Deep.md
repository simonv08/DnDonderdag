...
traits: ["[[Deep#Alignment|Alignment]]", "[[Deep#Superior Darkvision|Superior Darkvision]]", "[[Deep#Stone Camouflage|Stone Camouflage]]"]
dex_mod: 1
...
***Stone Camouflage.*** You have advantage on Dexterity ([[Skills#Stealth|Stealth]]) checks to hide in rocky terrain.
