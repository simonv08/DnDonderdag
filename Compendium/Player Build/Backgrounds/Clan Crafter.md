...
traits: ["[[Clan Crafter#Respect Of The Stout Folk|Respect of the Stout Folk]]", "[[Clan Crafter#Suggested Characteristics|Suggested Characteristics]]"]
...
**Languages:** Dwarvish, 1 of your choice
...
Use the tables for the  background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a clan crafter. (For instance, consider the words "guild" and "clan" to be interchangeable.)
