...
traits: ["[[Lorehold Student#Lorehold Initiate|Lorehold Initiate]]", "[[Lorehold Student#Building A Lorehold Character|Building a Lorehold Character]]", "[[Lorehold Student#Suggested Characteristics|Suggested Characteristics]]", "[[Lorehold Student#Lorehold Trinkets|Lorehold Trinkets]]"]
...
You gain the  feat and must choose Lorehold within it.
...
Any class or subclass that deals with knowledge of the past can be a good fit in Lorehold. Bards thrive in Lorehold, and wizards (particularly those of the ) are numerous among its students. Clerics (often with the  or  domains) are also quite common.

For a more unusual take on a Lorehold student, you could consider playing a barbarian with a primal connection to the past (perhaps adopting the  from Xanathar's Guide to Everything) or a paladin whose  gives a concrete link to history.
