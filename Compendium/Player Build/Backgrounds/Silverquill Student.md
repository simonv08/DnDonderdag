...
traits: ["[[Silverquill Student#Silverquill Initiate|Silverquill Initiate]]", "[[Silverquill Student#Building A Silverquill Character|Building a Silverquill Character]]", "[[Silverquill Student#Suggested Characteristics|Suggested Characteristics]]", "[[Silverquill Student#Silverquill Trinkets|Silverquill Trinkets]]"]
...
You gain the  feat and must choose Silverquill within it.
...
Many bards find a home in Silverquill, putting the power of their voices to use with Silverquill magic. Wizards (especially those who study the Schools of  and ) are common in Silverquill, as are warlocks. Clerics with the Divine Domains of  and  also fit in well among the mages of Silverquill.
