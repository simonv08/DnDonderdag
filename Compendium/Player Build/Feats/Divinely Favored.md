...
| --- | --- |
| Evil | Choose one {@filter 1st-level warlock spell|spells|level=1|class=warlock} |
| Good | Choose one {@filter 1st-level cleric spell|spells|level=1|class=cleric} |
| Neutral | Choose one {@filter 1st-level druid spell|spells|level=1|class=druid} |
