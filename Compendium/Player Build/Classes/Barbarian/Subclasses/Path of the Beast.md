...
- ***Claws.*** Each of your hands transforms into a claw, which you can use as a weapon if it's empty. It deals 1d6 slashing damage on a hit. Once on each of your turns when you attack with a claw using the [[Actions#Attack|Attack]] action, you can make one additional claw attack as part of the same action.
