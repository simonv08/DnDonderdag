---
traits: ["[[Pyromancer (PSK)#Pyromancer PSK|Pyromancer (PSK)]]", "[[Pyromancer (PSK)#Heart Of Fire|Heart of Fire]]", "[[Pyromancer (PSK)#Fire In The Veins|Fire in the Veins]]", "[[Pyromancer (PSK)#Pyromancers Fury|Pyromancer's Fury]]", "[[Pyromancer (PSK)#Fiery Soul|Fiery Soul]]"]
---
