---
traits: ["[[Way of the Ascendant Dragon#Way Of The Ascendant Dragon|Way of the Ascendant Dragon]]", "[[Way of the Ascendant Dragon#Breath Of The Dragon|Breath of the Dragon]]", "[[Way of the Ascendant Dragon#Draconic Disciple|Draconic Disciple]]", "[[Way of the Ascendant Dragon#Wings Unfurled|Wings Unfurled]]", "[[Way of the Ascendant Dragon#Aspect Of The Wyrm|Aspect of the Wyrm]]", "[[Way of the Ascendant Dragon#Ascendant Aspect|Ascendant Aspect]]"]
---
...
You can channel destructive waves of energy, like those created by the dragons you emulate. When you take the [[Actions#Attack|Attack]] action on your turn, you can replace one of the attacks with an exhalation of draconic energy in either a 20-foot cone or a 30-foot line that is 5 feet wide (your choice). Choose a damage type: acid, cold, fire, lightning, or poison. Each creature in that area must make a Dexterity saving throw against your ki save DC, taking damage of the chosen type equal to two rolls of your Martial Arts die on a failed save, or half as much damage on a successful one.
...
- ***Frightful Presence.*** When you create this aura, and as a bonus action on subsequent turns, you can choose a creature within the aura. The target must succeed on a Wisdom saving throw against your ki save DC or become [[Conditions#frightened|Frightened]] of you for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a successful save.
...
- ***Blindsight.*** You gain blindsight out to 10 feet. Within that range, you can effectively see anything that isn't behind Cover, even if you're [[Conditions#blinded|Blinded]] or in darkness. Moreover, you can see an [[Conditions#invisible|Invisible]] creature within that range, unless the creature successfully hides from you.
