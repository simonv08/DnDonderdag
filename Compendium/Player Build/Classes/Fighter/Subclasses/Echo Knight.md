---
traits: ["[[Echo Knight#Echo Knight|Echo Knight]]", "[[Echo Knight#Manifest Echo|Manifest Echo]]", "[[Echo Knight#Unleash Incarnation|Unleash Incarnation]]", "[[Echo Knight#Echo Avatar|Echo Avatar]]", "[[Echo Knight#Shadow Martyr|Shadow Martyr]]", "[[Echo Knight#Reclaim Potential|Reclaim Potential]]", "[[Echo Knight#Legion Of One|Legion of One]]"]
---
...
You can use a bonus action to magically manifest an echo of yourself in an unoccupied space you can see within 15 feet of you. This echo is a magical, translucent, gray image of you that lasts until it is destroyed, until you dismiss it as a bonus action, until you manifest another echo, or until you're [[Conditions#incapacitated|Incapacitated]].
...
- When you take the [[Actions#Attack|Attack]] action on your turn, any attack you make with that action can originate from your space or the echo's space. You make this choice for each attack.
- When a creature that you can see within 5 feet of your echo moves at least 5 feet away from it, you can use your reaction to make an opportunity attack against that creature as if you were in the echo's space.

### Unleash Incarnation

You can heighten your echo's fury. Whenever you take the [[Actions#Attack|Attack]] action, you can make one additional melee attack from the echo's position.
