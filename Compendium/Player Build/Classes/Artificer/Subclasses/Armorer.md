---
traits: ["[[Armorer#Armorer|Armorer]]", "[[Armorer#Dampening Field|Dampening Field]]", "[[Armorer#Defensive Field|Defensive Field]]", "[[Armorer#Lightning Launcher|Lightning Launcher]]", "[[Armorer#Powered Steps|Powered Steps]]", "[[Armorer#Thunder Gauntlets|Thunder Gauntlets]]", "[[Armorer#Arcane Armor|Arcane Armor]]", "[[Armorer#Armor Model|Armor Model]]", "[[Armorer#Armorer Spells|Armorer Spells]]", "[[Armorer#Tools Of The Trade|Tools of the Trade]]", "[[Armorer#Extra Attack|Extra Attack]]", "[[Armorer#Armor Modifications|Armor Modifications]]", "[[Armorer#Guardian|Guardian]]", "[[Armorer#Infiltrator|Infiltrator]]", "[[Armorer#Perfected Armor|Perfected Armor]]"]
---
...
You can attack twice, rather than once, whenever you take the [[Actions#Attack|Attack]] action on your turn.
