...
- You can use an action to cause poison to coat the rapier's blade. The poison remains for 1 minute or until an attack using this weapon hits a creature. That creature must succeed on a 13 Constitution saving throw or become [[Conditions#poisoned|Poisoned]] for 1 hour. If the saving throw fails by 5 or more, the creature is also [[Conditions#unconscious|Unconscious]] while [[Conditions#poisoned|Poisoned]] in this way. The creature wakes up if it takes damage or if another creature uses its action to shake the creature awake.
- While carrying the rapier, you can move up, down, and across vertical surfaces and upside down along ceilings, while leaving your hands free. You have a climbing speed equal to your walking speed. Additionally, you can't be caught in webs of any sort and can move through webs as if they were [[Rules#Difficult Terrain]].

#### Betrayer Artifact Properties
The Arms of the Betrayers advance in power in the same manner as the Vestiges of Divergence. In its dormant state, each of these artifacts has one  property and one  property. When the artifact attains an awakened state, it gains an additional  property and an additional  property. When the item reaches its exalted state, it gains a  property. See "Artifact Properties" in chapter 7 of the Dungeon Master's Guide for more information.
