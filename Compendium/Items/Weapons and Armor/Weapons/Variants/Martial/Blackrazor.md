...
Attunement: true
Attune_Req: ["NX", "Chaotic", "Good", "NY", "Evil"]
...
#### Soul Hunter
While you hold the weapon. you are aware of the presence of Tiny or larger creatures within 60 feet of you that aren't constructs or undead. You also can't be [[Conditions#charmed|Charmed]] or [[Conditions#frightened|Frightened]].
Blackrazor can cast the [[Haste]] spell on you once per day. It decides when to cast the spell and maintains [[Statuss#concentration|Concentration]] on it so that you don't have to.
#### Sentience
