...
This shield is made from the scale of an ancient white dragon. It has a rune burned into its outward-facing side. A character who examines the rune and succeeds on a 20 Intelligence ([[Skills#History|History]]) check recognizes it as an uven ("enemy" in Giant) rune that confers great power.
...
#### Bane
You can cast the [[Bane]] spell from the shield (save 17). The spell does not require [[Statuss#concentration|Concentration]] and lasts for 1 minute. Once you cast the spell from the shield, you can't do so again until you finish a short or long rest.
#### Gift of Vengeance
