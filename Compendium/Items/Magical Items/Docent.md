...
Attune_Req: []
vermun: false
source: ["Explorer's Guide to Wildemount", "Vecna: Eve of Ruin"]
ruleset: "D&D 5e (2014)"
---
...
#### Life Support
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([[Skills#Medicine|Medicine]]) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
#### Random Properties
...
. The docent has a +7 bonus to one of the following skills (roll a d4): (1) [[Skills#Arcana|Arcana]], (2) [[Skills#History|History]], (3) [[Skills#Investigation|Investigation]], or (4) [[Skills#Nature|Nature]].
. The docent knows one of the following spells and can cast it at will, requiring no components (roll a d6): (1–2) [[Detect Evil And Good]] or (3–6) [[Detect Magic]]. The docent decides when to cast the spell.
#### Personality
