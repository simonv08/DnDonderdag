...
Attunement: false
vermun: false
source: ["Baldur's Gate: Descent Into Avernus", "Vecna: Eve of Ruin", "Chains of Asmodeus"]
ruleset: "D&D 5e (2014)"
---
...
A soul can also be freed by destroying the coin that contains it. A soul coin has AC 19, 1 hit point for each charge it has remaining, and immunity to all damage except that which is dealt by a [[Hellfire Weapon]] or an infernal war machine's furnace (see "").
