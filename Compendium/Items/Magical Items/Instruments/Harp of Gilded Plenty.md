...
#### Soothing Melody
As an action, you can use the harp to cast the [[Calm Emotions]] spell (save 19). When the spell is cast using the harp, its duration increases to 1 hour, provided you maintain [[Statuss#concentration|Concentration]] on the spell. This property can be used five times, and it regains all uses at dawn.
#### Sentience
