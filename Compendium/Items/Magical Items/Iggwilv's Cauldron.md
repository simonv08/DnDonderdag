...
- 1  property (determined by rolling on the  Properties table in the Dungeon Master's Guide)
- 1  property (determined by rolling on the  Properties table in the Dungeon Master's Guide)
...
- If at least 1 gallon of blood is poured into the cauldron and stirred for 1 minute, it turns into a cloud of harmless black smoke that erupts from the cauldron and dissipates quickly. At the same time, all Humanoid creatures within a certain radius of the cauldron fall [[Conditions#unconscious|Unconscious]] for 1 hour, except those that are attuned to the cauldron or immune to being [[Conditions#charmed|Charmed]]. The radius of the effect is 100 feet per gallon of blood used. An [[Conditions#unconscious|Unconscious]] creature awakens if it takes damage or if someone uses an action to shake or slap it. Once used, this property of the cauldron can't be used again until the next dawn.
