...
This backpack contains the spirit of an [[Air Elemental]] and a compact leather balloon. While you're wearing the backpack, you can deploy the balloon as an action and gain the effect of the [[Levitate]] spell for 10 minutes, targeting yourself and requiring no [[Statuss#concentration|Concentration]]. Alternatively, you can use a reaction to deploy the balloon when you're falling and gain the effect of the [[Feather Fall]] spell for yourself.
